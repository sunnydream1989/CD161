...
data = read.csv('../../data/Imvigor210/treatment_response/treatment_response.csv')
...
data$name <- factor(data$name,levels = c("CR", "PR", "SD", "PD"))
...
p
ggsave(paste('../../data/Imvigor210/treatment_response/', 'treatment_response',"_plot.pdf", sep=''),width = 10,height = 10,units = "cm")
