...
xCell_data = read.csv('../../data/CIBERSORT/CIBERSORTx_TCGA_Results.csv', sep=',', check.names = F)
...
ggsave(paste(result_dir, "TCGA_CIBERSORTx_plot.pdf", sep=''),width = 30,height = 18,units = "cm")
